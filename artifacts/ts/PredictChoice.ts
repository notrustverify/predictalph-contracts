...
export const PredictChoice = new Factory(
  Contract.fromJson(
    ...
    "=10-2+5f=2+9=1-1=2-2+b0=2-2+be=2-2+3d=2-5+9=3-2+6a=2-3=1-1=3-1+7d4=1+9c=2-2+bf=2-1=2-3=2-2+e9=2+f=1-1+44134429=91-1+e=24+7e0218526f756e6443686f69636520636f6e747261637420696420001601=25-1+d=18+16017e0218526f756e6443686f69636520636f6e74726163742069642000=1850",
    "d71a7195a0742653388474e2fd3fd933feb81be152442a070cecf1ed0204c2be",
    AllStructs
  )
);
